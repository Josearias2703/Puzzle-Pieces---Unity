...
public class Memory : MonoBehaviour
{
    ...
    private MoverCartas moverCartas;
    ...
    void Start()
    {
        ...
        print("Usuario: " + dontDestroy.cedulaUsuario);
    ...
    void Update()
    {
        ...
        if (MoverCartas.contador == 4)          //Para acceder a una variable static
        {
            if (terminarJuego == 3)
            {
                terminarJuego = 6;
                ...
                terminarRondas();
                FindObjectOfType<DBManager>().BtnGuardarPartidaNueva(dontDestroy.cedulaUsuario, "Cartas", "Medio", numeroAciertos, 
    ...
    public void terminarRondas()
    {
        ...
        MoverCartas.lockPosicion0 = false;
        MoverCartas.contador++;
    }
    ...
    IEnumerator nuevaRonda(float time)
    {
        ...
        FindObjectOfType<Memory>().PlayCards();
        FindObjectOfType<UpdateSprite>().CrearCartas();
        FindObjectOfType<MoverCartas>().IniciarMovimientos();
