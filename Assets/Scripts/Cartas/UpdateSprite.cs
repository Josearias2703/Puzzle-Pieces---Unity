...
public class UpdateSprite : MonoBehaviour
{
    ...
    public void CrearCartas()
    {
        ...
        List<string> deck = Memory.GenerateDeck();   //se genera lista donde string (s+v) y los sprites (caras de cartas) son las mismas
        memory = FindObjectOfType<Memory>(); //para acceder a los sprites de Memory (caras de cartas)
