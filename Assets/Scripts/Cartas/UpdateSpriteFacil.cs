...
public class UpdateSpriteFacil : MonoBehaviour
{
    ...
    public void CrearCartas()
    {
        ...
        List<string> deck = MemoryFacil.GenerateDeck();   //se genera lista donde string (s+v) y los sprites (caras de cartas) son las mismas
        memory = FindObjectOfType<MemoryFacil>(); //para acceder a los sprites de Memory (caras de cartas)
