...
public class UpdateLetra : MonoBehaviour
{
    ...
    {
        List<string> deck = Palabras.GenerateAlphabet();   //se genera lista donde string (s+v) y los sprites (caras de cartas) son las mismas
