...
public class UpdateLetraDificil : MonoBehaviour
{
    ...
    {
        List<string> deck = PalabrasDificil.GenerateAlphabet();   //se genera lista donde string (s+v) y los sprites (caras de cartas) son las mismas
