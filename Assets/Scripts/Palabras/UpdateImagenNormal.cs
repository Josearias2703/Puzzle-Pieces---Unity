...
public class UpdateImagenNormal : MonoBehaviour
{
    ...
    {
        List<string> deck = PalabrasNormal.GenerateImages();   //se genera lista donde string (s+v) y los sprites (caras de cartas) son las mismas
